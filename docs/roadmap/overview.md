...
- **v12.0** (2026-02-17): Sprint 19 (Human-First Agent Onboarding) COMPLETE. 30 tasks, 7 user stories, 21 FRs. Human-first agent creation under human accounts, API key management, agent CRUD (7 endpoints), ownership enforcement, verification inheritance, deprecated old registration, SKILL.md updated. 1,521+ total tests.
